"""Reproduce Figure 4d: generalisability of factor geometry to CNeuroMod."""
...
LABEL_POSITIONS = {
    ...
    "animal": (-1.53, -0.18),
    "clothing": (-0.63, -0.62),
    "decoration": (-0.77, 0.25),
    "sports equipment": (-0.10, -1.08),
    "weapon": (0.20, -0.17),
    "toy": (-0.05, 0.35),
    "tool": (0.35, 0.48),
    "musical instrument": (0.30, 0.70),
    "container": (0.86, 0.34),
    "vehicle": (0.45, 1.45),
    "furniture": (0.90, 2.28),
    "plant": (1.02, -0.68),
